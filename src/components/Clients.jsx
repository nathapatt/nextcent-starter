...
const clientImgLogos = [clientImgLogo01,clientImgLogo02,clientImgLogo03,clientImgLogo04,clientImgLogo05,clientImgLogo06,clientImgLogo07];
  ...
  return (
    <div className='container mx-auto max-w-[1320px] py-10 text-center'>
        ...
        <ul className='flex flex-col items-center m-10 md:flex-row md:justify-between'>
            {clientImgLogos.map((client,index) => (
                <li key={index}>
                    <img src={client} alt=''/>
                </li>
            ))}
