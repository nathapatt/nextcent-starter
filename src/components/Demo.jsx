  ...
  return (
    <div className='bg-[#F5F7FA] py-10 flex justify-center text-center'>
        <div>
            ...
            <a className='inline-flex justify-center items-center py-3 px-8 mt-10 bg-[#4CAF4F] text-white rounded-md' href='#'>Get a Demo <HiOutlineArrowNarrowRight className='ml-2'/></a>
        </div>
    </div>
  )
}
